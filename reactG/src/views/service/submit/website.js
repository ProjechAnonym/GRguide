...
import { getParameter, submitWeb } from "../../../utils/submit";
      ...
      <Spin spinning={spin}>
        <form
          ...
          onSubmit={(e) => {
            ...
            const iconLink = getParameter(iconlink, icon, group, name, id);
            submitWeb(icon, iconLink, url, group, name, id, token)
              .then((res) => {
                Notification.info({
                  className: dark
                    ? "dark-submitNotificationzone"
